 ...
 * @author CARLOS
 */
public class Mensual extends javax.swing.JInternalFrame {
    ...
    void cargar (String valor){
        try{//                   0         1         2        3          4           5          6                 7                 8   
            ...
            model=new DefaultTableModel(null, titulos);
                                                                //2              3            4          5                  6            7        8            9                 
            String cons = "SELECT * FROM mensual WHERE CONCAT (`id_men`, `codboleta_men`, `cod_men`, `horafecha_men`, `desc_men`, `cant_men`, `preu_men`, `total_men`) LIKE '%"+valor+"%'";
    ...
    void total(){
        ...
        for(int i=0; i<tbMensual.getRowCount(); i++){
            can=tbMensual.getValueAt(i, 5).toString();
            pre=tbMensual.getValueAt(i, 7).toString();
    ...
    private void initComponents() {
        ...
        tbMensual = new javax.swing.JTable();
        ...
        tbMensual.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        jScrollPane1.setViewportView(tbMensual);
    ...
    private javax.swing.JTable tbMensual;
