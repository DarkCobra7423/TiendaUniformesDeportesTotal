 ...
 * @author CARLOS
 */
public class Diaria extends javax.swing.JInternalFrame {

    DefaultTableModel model;
    /**
     * Creates new form Diaria
     */
    public Diaria() {
        initComponents();
        cargar("");
    ...
    void cargar (String valor){
        try{//                   0         1         2        3          4           5          6                 7                 8   
            ...
            model=new DefaultTableModel(null, titulos);
                                                                //2              3            4          5                  6            7        8            9                 
            String cons = "SELECT * FROM diaria WHERE CONCAT (`id_dia`, `codboleta_dia`, `cod_dia`, `horafecha_dia`, `desc_dia`, `cant_dia`, `preu_dia`, `total_dia`) LIKE '%"+valor+"%'";
    ...
    void total(){
        ...
        for(int i=0; i<tbDiaria.getRowCount(); i++){
            can=tbDiaria.getValueAt(i, 5).toString();
            pre=tbDiaria.getValueAt(i, 7).toString();
